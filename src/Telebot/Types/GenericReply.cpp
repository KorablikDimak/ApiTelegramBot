...
void Telebot::GenericReply::ToJson(ExtendedCpp::Json& json, const GenericReply::Ptr& object) noexcept {}

void Telebot::InlineKeyboardMarkup::ToJson(ExtendedCpp::Json& json, const GenericReply::Ptr& object) noexcept
{
...
void Telebot::ForceReply::ToJson(ExtendedCpp::Json& json, const GenericReply::Ptr& object) noexcept
{
...
void Telebot::ReplyKeyboardMarkup::ToJson(ExtendedCpp::Json& json, const GenericReply::Ptr& object) noexcept
{
...
void Telebot::ReplyKeyboardRemove::ToJson(ExtendedCpp::Json& json, const GenericReply::Ptr& object) noexcept
{
