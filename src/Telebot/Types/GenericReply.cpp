...
void Telebot::InlineKeyboardMarkup::SetButton(const InlineKeyboardButton::Ptr& button, const unsigned char row, const unsigned char column)
{
...
void Telebot::InlineKeyboardMarkup::RemoveButton(const unsigned char row, const unsigned char column)
{
...
void Telebot::GenericReply::ToJson(Json::Json& json, const GenericReply::Ptr& object) {}

void Telebot::InlineKeyboardMarkup::ToJson(Json::Json& json, const GenericReply::Ptr& object)
{
...
void Telebot::ForceReply::ToJson(Json::Json& json, const GenericReply::Ptr& object)
{
...
void Telebot::ReplyKeyboardMarkup::ToJson(Json::Json& json, const GenericReply::Ptr& object)
{
...
void Telebot::ReplyKeyboardRemove::ToJson(Json::Json& json, const GenericReply::Ptr& object)
{
